...
![The project details page for a package. The launch package dialog is open with the following disclaimer: once a package is launched, it's visible to everyone. You cannot undo this action. A second disclaimer reads you can install this package withing your organization without launching. The dialog includes action buttons to cancel or launch.|16/9](launch-a-package.webp 'Launch a package')
