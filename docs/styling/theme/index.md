...
To access the theme editor, open the [project sidebar](/the-editor/project-sidebar#project-sidebar) and find the `Themes` section. You can also open the theme dialog from the [bottom-bar](/the-editor/bottom-bar#bottom-bar) when editing a component to edit your theme with a live view of your changes in context.
