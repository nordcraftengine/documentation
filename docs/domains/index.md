...
![Image alt text|16/9](edit-domain.webp 'Edit domain button on project overview page')
...
![Image alt text|16/9](create-domain.webp 'Setup a new domain')
...
![Image alt text|16/9](create-wildcard-domain.webp 'Setup a new wildcard domain')

1. Add the domain name and click **Add domain**. Remember to prepend the domain with `*.` to indicate it's a wildcard domain.
2. You will see the domain added to the list of domains with a status of **Pending**
3. Under the domain you will see instructions on how to configure your DNS settings to point the domain to your Nordcraft project.
